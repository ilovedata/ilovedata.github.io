...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df1s}\SpecialCharTok{$}\NormalTok{Month }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{,}\DecValTok{2}\NormalTok{)}
\NormalTok{df1s }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Month,  }\AttributeTok{y =}\NormalTok{ meanDBP, }\AttributeTok{colour =}\NormalTok{ TRT)) }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{() }
\end{Highlighting}
\end{Shaded}

\includegraphics{Clinical-Trial_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{Clinical-Trial_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{Clinical-Trial_files/figure-latex/unnamed-chunk-10-1.pdf}
